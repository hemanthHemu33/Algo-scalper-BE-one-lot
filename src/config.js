...
const schema = z.object({
  ...
  EARLY_WINNER_RETENTION_ENABLED: boolFromEnv.default(true),
  EARLY_WINNER_ARM_R: z.coerce.number().default(0.4),
  EARLY_WINNER_CONFIRM_TICKS: z.coerce.number().default(2),
  EARLY_WINNER_CONFIRM_MS: z.coerce.number().default(3000),
  EARLY_WINNER_REQUIRE_BAR_CONFIRM: boolFromEnv.default(false),
  EARLY_WINNER_MIN_KEEP_R: z.coerce.number().default(0.08),
  EARLY_WINNER_MAX_KEEP_R: z.coerce.number().default(0.22),
  EARLY_WINNER_MFE_LOCK_MODE: z.string().default("RATIO"),
  EARLY_WINNER_TIER_1_R: z.coerce.number().default(0.5),
  EARLY_WINNER_TIER_1_KEEP_R: z.coerce.number().default(0.12),
  EARLY_WINNER_TIER_2_R: z.coerce.number().default(0.65),
  EARLY_WINNER_TIER_2_KEEP_R: z.coerce.number().default(0.2),
  EARLY_WINNER_TIER_3_R: z.coerce.number().default(0.8),
  EARLY_WINNER_TIER_3_KEEP_R: z.coerce.number().default(0.3),
  EARLY_WINNER_TO_TRAIL_MIN_R: z.coerce.number().default(0.75),
  EARLY_WINNER_TO_TRAIL_REQUIRE_HEALTH: boolFromEnv.default(true),
  EARLY_WINNER_MAX_GIVEBACK_AFTER_ARM_R: z.coerce.number().default(0.1),
  EARLY_WINNER_REENTRY_HYSTERESIS_R: z.coerce.number().default(0.03),
  EARLY_WINNER_MIN_HOLD_MS: z.coerce.number().default(5000),
  EARLY_WINNER_USE_STRUCTURE: boolFromEnv.default(true),
  EARLY_WINNER_STRUCTURE_BUFFER_TICKS: z.coerce.number().default(4),
  EARLY_WINNER_STRUCTURE_MAX_DISTANCE_R: z.coerce.number().default(0.3),
  EARLY_WINNER_STRUCTURE_REQUIRE_FRESH: boolFromEnv.default(true),
  EARLY_WINNER_DYNAMIC_HANDOFF_ENABLED: boolFromEnv.default(true),
  EARLY_WINNER_DYNAMIC_HANDOFF_MIN_R: z.coerce.number().default(0.6),
  EARLY_WINNER_DYNAMIC_HANDOFF_MAX_R: z.coerce.number().default(0.85),
  EARLY_WINNER_HANDOFF_SPREAD_BPS_MAX: z.coerce.number().default(25),
  EARLY_WINNER_HANDOFF_REQUIRE_STRUCTURE_BONUS:
    boolFromEnv.default(false),
  PROTECTION_DEDUPE_ENABLED: boolFromEnv.default(true),
  PROTECTION_NOOP_WRITE_SKIP: boolFromEnv.default(true),
  PROTECTION_CONFLICT_RETRY_ONCE: boolFromEnv.default(true),
  ...
  TELEGRAM_TRADE_CARD_ENABLED: z.string().default("true"),
  TELEGRAM_TRADE_CARD_MIN_REFRESH_SEC: z.coerce.number().default(15),
  TELEGRAM_TRADE_CARD_PNL_DELTA_INR: z.coerce.number().default(100),
  TELEGRAM_TRADE_CARD_LTP_DELTA: z.coerce.number().default(0.25),
  TELEGRAM_TRADE_CARD_FORCE_REFRESH_SEC: z.coerce.number().default(90),
  TELEGRAM_INCIDENTS_ENABLED: z.string().default("true"),
  TELEGRAM_HEARTBEAT_ENABLED: z.string().default("false"),
  TELEGRAM_HEARTBEAT_SEC: z.coerce.number().default(900),
  TELEGRAM_HEARTBEAT_WHEN_CLOSED: z.string().default("false"),
  TELEGRAM_NOTIFICATION_DEBUG: z.string().default("false"),
  TELEGRAM_DEDUPE_TTL_SEC: z.coerce.number().default(21600),
  ...
  ADAPTIVE_LOSER_COMPRESSION_ENABLED: boolFromEnv.default(true),
  ALC_MIN_GRACE_MS: z.coerce.number().default(15000),
  ALC_MIN_BARS: z.coerce.number().default(1),
  ALC_SCORE_COMPRESS_L1: z.coerce.number().default(70),
  ALC_SCORE_COMPRESS_L2: z.coerce.number().default(85),
  ALC_SCORE_EXIT_NOW: z.coerce.number().default(95),
  ALC_MAX_MFE_FOR_FAILURE_R: z.coerce.number().default(0.10),
  ALC_ADVERSE_R_L1: z.coerce.number().default(0.40),
  ALC_ADVERSE_R_L2: z.coerce.number().default(0.60),
  ALC_ADVERSE_R_EXIT: z.coerce.number().default(0.85),
  ALC_L1_REMAINING_R_CAP: z.coerce.number().default(0.70),
  ALC_L2_REMAINING_R_CAP: z.coerce.number().default(0.50),
  ALC_REQUIRE_STRUCTURE_FOR_COMPRESSION: boolFromEnv.default(true),
  ALC_ALLOW_EXIT_WITHOUT_STRUCTURE_ON_EXTREME_FAILURE:
    boolFromEnv.default(true),
  ALC_MAX_RETRIES_PER_LEVEL: z.coerce.number().default(3),
  ALC_MAX_RETRIES_L1: z.coerce.number().default(3),
  ALC_MAX_RETRIES_L2: z.coerce.number().default(3),
  ALC_MAX_RETRIES_EXIT: z.coerce.number().default(2),
  ALC_RETRY_COOLDOWN_MS: z.coerce.number().default(4000),
  ALC_PENDING_STALE_MS: z.coerce.number().default(8000),
  ALC_SUPERSEDE_PENDING_L1_WITH_L2: boolFromEnv.default(true),
  ALC_UNDERLYING_FAIL_BPS: z.coerce.number().default(12),
  ALC_UNDERLYING_FAIL_BPS_MAX: z.coerce.number().default(24),
  ALC_UNDERLYING_FAIL_WEIGHT: z.coerce.number().default(1),
  ALC_REQUIRE_UNDERLYING_CONFIRMATION: boolFromEnv.default(false),
  ALC_UNDERLYING_FAIL_USE_TRIGGER_REFERENCE: boolFromEnv.default(true),
  ALC_UNDERLYING_FAIL_USE_STRUCTURE_REFERENCE: boolFromEnv.default(true),
  ALC_MICROSTRUCTURE_MAX_SCORE: z.coerce.number().default(10),
  ALC_MICROSTRUCTURE_SPREAD_BPS_SOFT: z.coerce.number().default(60),
  ALC_MICROSTRUCTURE_SPREAD_BPS_HARD: z.coerce.number().default(120),
  ALC_MICROSTRUCTURE_FRESHNESS_MS_SOFT: z.coerce.number().default(1500),
  ALC_MICROSTRUCTURE_FRESHNESS_MS_HARD: z.coerce.number().default(3500),
...
(function logConfigFingerprint() {
  ...
  const safeConfig = {
    ...
    earlyWinnerEnabled: env.EARLY_WINNER_RETENTION_ENABLED,
    earlyWinnerArmR: env.EARLY_WINNER_ARM_R,
    earlyWinnerTrailHandoffR: env.EARLY_WINNER_TO_TRAIL_MIN_R,
    earlyWinnerDynamicHandoffEnabled: env.EARLY_WINNER_DYNAMIC_HANDOFF_ENABLED,
    earlyWinnerDynamicHandoffMinR: env.EARLY_WINNER_DYNAMIC_HANDOFF_MIN_R,
    earlyWinnerDynamicHandoffMaxR: env.EARLY_WINNER_DYNAMIC_HANDOFF_MAX_R,
    earlyWinnerStructureMaxDistanceR:
      env.EARLY_WINNER_STRUCTURE_MAX_DISTANCE_R,
    protectionDedupeEnabled: env.PROTECTION_DEDUPE_ENABLED,
    protectionConflictRetryOnce: env.PROTECTION_CONFLICT_RETRY_ONCE,
